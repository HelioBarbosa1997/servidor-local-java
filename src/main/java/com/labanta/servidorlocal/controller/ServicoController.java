...
*/
        @Operation (summary = "Listar dos oserviços",
                description = "Rota para listar todos os serviços exixtentes na plataforma")
        @GetMapping
        ...
        public ServicoModel criarServico(@RequestBody ServicoModel novoServico) {
            ...
            //Exercicio 11
            @Operation (summary = "Buscar um servico atraves de um ID",
                        description = "Rota que busca um servico atraves ce um ID"
            )
        @GetMapping("/{id}")
    ...
    //exercicio 13
        @Operation (summary = "Pesquisar por um serviço",
                description = "Rota para pesquisar Servico"
        )
        @GetMapping("/pesquisa")
    ...
    //aula 19
        @Operation (summary = "Pedir um orcamento",
        description = "Pedir um orcamento atraves de um ID"
        )
        @SecurityRequirement(name = "BearerAuth")
